...
import { Menu, ChevronDown, X, Home, Sparkles, Camera, Heart, Clock, Star, BookOpen } from "lucide-react";
            ...
            <div className="flex h-16 items-center justify-between gap-2">
              ...
              <div className="desktop-nav hidden min-[1024px]:flex min-[1024px]:items-center min-[1024px]:gap-6 relative z-10">
                ...
                >
                  ...
                  <div 
                    className={`ai-tools-dropdown-panel-glass absolute top-full left-0 mt-2 min-w-[250px] z-[1001] transition-all duration-200 ${
                      isDropdownOpen 
