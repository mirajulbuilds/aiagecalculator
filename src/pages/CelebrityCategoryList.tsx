...
const CelebrityCategoryList = () => {
  ...
  const loadCelebrities = async () => {
    try {
      ...
      const { data, error } = await supabase.functions.invoke('celebrity-data', {
        body: { type: 'category', category: categoryName }
      });
  ...
  return (
    <>
      <Helmet>
        <title>{categoryName} - Famous Birthdays & Ages | AiAgeCalc.com</title>
        <meta 
          name="description" 
          content={`Discover the ages and birthdays of famous ${categoryName.toLowerCase()}. Find out how old your favorite celebrities are.`}
        />
      </Helmet>
