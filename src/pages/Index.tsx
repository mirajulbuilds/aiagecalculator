      ...
      <div className="max-w-5xl mx-auto flex flex-col xl:flex-row gap-4 xl:gap-6">
        ...
        <section className="bg-card rounded-2xl shadow-card p-6 md:p-8 mb-6 hover-lift" aria-label="Age calculators">
          <Tabs defaultValue="calculator" value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <SelectTrigger className="h-10 bg-card text-foreground border-2 border-primary/20 shadow-lg shadow-primary/10 hover:shadow-xl hover:shadow-primary/20 transition-shadow duration-300">
