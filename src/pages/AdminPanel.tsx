      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-5 mb-8">
            ...
            <TabsTrigger value="blog">AI Blog Generator</TabsTrigger>
          </TabsList>
          ...
          {/* TAB 5: AI BLOG GENERATOR */}
          <TabsContent value="blog" className="space-y-6">
            <div className="p-6 border border-border rounded-lg bg-card space-y-6">
              <div>
                <h2 className="text-2xl font-semibold text-foreground mb-2">
                  AI Blog Post Generator with Images
                </h2>
                <p className="text-muted-foreground">
                  Generate complete blog posts with AI, including featured images and in-body illustrations. Perfect for creating engaging content about age calculations, birthdays, and zodiac topics.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g., A vibrant image of zodiac signs for compatibility"
                  />
                  <p className="text-sm text-muted-foreground">
                    A short description for the main blog image. AI will generate it.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g., zodiac wheel diagram, birthday cake celebration, age calculator interface"
                  />
                  <p className="text-sm text-muted-foreground">
                    Describe 2-3 images for the blog body, separated by commas. AI will generate and suggest placement.
                  </p>
                </div>
